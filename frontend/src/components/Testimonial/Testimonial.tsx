        ...
        <div id='testimonials'>
            ...
            <div className='containerTesti'>
                <div className='profilT'>
                    <img width='200px' src='../../src/assets/images/profil-blandinegallet.webp' alt='blandineGallet' />
                ...
                <div className='profilT'>
                    <img width='200px' src='../../src/assets/images/profil-gerarddduchar.webp' alt='gerarddduchar' />
                    <h4>Gérard DUCHAR</h4>
                ...
                <div className='profilT'>
                    <img width='200px' src='../../src/assets/images/profil-lucettefrot.webp' alt='lucettefrot' />
                    <h4>Lucette FROT</h4>
                ...
                <div className='profilT'>
                    <img width='200px' src='../../src/assets/images/profil-guillaumegentil.webp' alt='guillaumegentil' />
