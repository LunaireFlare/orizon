...
const mockEvent = [
    {
        ...
        start_date: "17 juin 2025",
        end_date: "17 juin 2025",
        city: "Paris",
        zip_code: 75000,
    ...
    },
    {
        ...
        start_date: "25 juin 2025",
        end_date: "25 juin 2025",
    ...
    },
    {
        ...
        name: "Concert jazz",
        start_date: "28 juin 2025",
        end_date: "28 juin 2025",
        city: "saint-denis",
        zip_code: 93200,
        description: "Concert de jazz en plein air avec des artistes comme Christine and the queen, et plein d'autre encore...",
        interest_id: "Musique"
    }
]
                ...
                {events.map(event => (
                    <div className="elmCard">
                        <div key={event.id}>
                            ...
                            <p><strong>{event.city}({event.zip_code})</strong></p>
